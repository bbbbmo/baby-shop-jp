...
export function KakaoIcon({ className = "h-[18px] w-[19px]" }: IconProps) {
  // 카카오 로그인 디자인 가이드는 심볼의 형태·비율·색상 변경을 금지한다.
  // 직접 그린 path는 공식 심볼과 미세하게 달라질 수 있어, 리소스 다운로드로
  // 받은 공식 버튼 이미지에서 심볼 영역만 추출한 에셋(2x, 36x34)을 그대로 쓴다.
  return (
    <Image
